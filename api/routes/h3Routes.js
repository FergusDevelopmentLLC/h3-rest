...
module.exports = function(app) {
  ...
  app.route('/h3NoData/:top_left/:bottom_left/:bottom_right/:top_right/:zoom')
    .get(h3.getH3BinsForExtentNoData);

  app.route('/h3/meteor')
    .get(h3.getMeteor);

  //https://boundingbox.klokantech.com
  //http://localhost:8670/h3/binsforbb/1/[-109.1950357997,36.944478699],[-101.8608644601,36.944478699],[-101.8608644601,41.0584355368],[-109.1950357997,41.0584355368],[-109.1950357997,36.944478699]
